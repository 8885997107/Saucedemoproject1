...
public class Saucedemo_checkoutstep2 {

	WebDriver driver;

	public Saucedemo_checkoutstep2(WebDriver driver) {
		PageFactory.initElements(driver, this);
	}

	@FindBy(xpath = "//div[@class='cart_list']/div[@class='cart_item']/div[2]/div[2]")
	private List<WebElement> CheckoutPriceList;
