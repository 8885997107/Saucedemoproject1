...
public class Saucedemo_testcases {

	WebDriver driver;
	Saucedemo_Login_page login;
	Saucedemo_Inventorypage inventory;
	Saucedemo_cartpage cp;
	Saucedemo_checkoutstep1 csop;
	Saucedemo_checkoutstep2 cstp;
	Saucedemo_checkoutcomplete ccp;
	...
	public void launchBrowser() {
		...
		login = new Saucedemo_Login_page(driver);
		inventory = new Saucedemo_Inventorypage(driver);
		cp = new Saucedemo_cartpage(driver);
		csop = new Saucedemo_checkoutstep1(driver);
		cstp = new Saucedemo_checkoutstep2(driver);
	}
...
//		System.out.println(ProductNamesAfter.get(i).getText());
	...
	public void checkoutCompletePageValidation() throws InterruptedException {
		...
		Assert.assertEquals(ccp.completeText(),
